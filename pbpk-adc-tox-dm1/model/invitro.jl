# date: 10/23/2024
# author: Yuezhe Li 
# purpose of this code: tumor in vitro model  
...
function invitro_model_her2!(du,u,p,t) 
    ...
    du.P_c_pos = DAR*(k_lys*AR_e + k_lys*A_e) - k_out*(P_c_pos - P_m) - k_kill_pos*P_c_pos - k_PL * P_c_pos
    du.P_m = k_out*(P_c_pos - P_m)*Vpos/V_medium - k_in*(P_m - P_c_neg)*Vneg/V_medium + Nc_1/tau*Vc/V_medium*P_c_pos - k_PL_ex*P_m
