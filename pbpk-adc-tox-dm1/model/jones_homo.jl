...
function jonesODEs_homo_tumor!(du,u,p,t) 
    @unpack C_EXG_Plasma, C_sR_plasma, C_sR_EXG, C_EDG_Plasma, C_EDG_LN, C_EDG, C_EXG_LN, C_EXG, C_FcRn_E6a, C_FcRn_E7, C_FcRn_E7b, C_FcRn_ISM, C_FcRn_VM, 
            tumor_ADC, DEGprotein, DegPL, end_cyto_payload, ints_payload = u
        
    @unpack infusion, tumor_cell_radius, PS_Score, PS_kd, KD6_WT, Prob_deg, kint_PS, DAR, 
            epsilon, P_ADC, D_ADC, Rcap, Rkrogh, thalf_sR, thalf_sR_adc, init_sR, Kon, Kd, k_out, frac_lys, k_PL, k_PL_ex = p

    # tumor volume as a dummy value; [L]
    TumorVolume = 1E-3
