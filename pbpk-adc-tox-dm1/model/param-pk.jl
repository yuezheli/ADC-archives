...
p_base = ComponentArray(
    ...
    P_ADC = 334 / 24,      # rate of permeability [um/h]; https://pubmed.ncbi.nlm.nih.gov/27029797/
    D_ADC = 0.022 / 24,    # rate of diffusion [cm^2/h]; https://pubmed.ncbi.nlm.nih.gov/27029797/
