# author: Yuezhe Li 
# date: 2/29/24
# purpose of this code: to host the base parameters for ADC
...
p_base = ComponentArray(
    ...
    k_kill_max = 0.0139,                   # maximum in vitro killing rate, [1/hr]
    ...
    ic50_pl = 23.8E-3,                      # payload IC50, [uM], https://europepmc.org/article/ppr/ppr584999
