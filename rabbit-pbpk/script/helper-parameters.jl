...
function create_base_pbpk_param(PS_Score, mdl; k_PL_ints_clearance = 0,  V_Plasma = 3.126)
    ...
    p_map_global = Dict([
        ...
        mdl.eye.icb.Endothelial_Cell_Frac => 1E-7,  # from rabbit tuning 
        mdl.eye.icb.PLQ => PLQ_ICB, 
        mdl.eye.icb.sigma_V => 0.99,    # Bussing and Shah, 2020; #  https://pubmed.ncbi.nlm.nih.gov/32876799/
        mdl.eye.icb.V_V => 1.38E-4 * 0.23, 
        mdl.eye.icb.V_IntS => 1.38E-4 * 0.34, 
        ...
        mdl.eye.retina.Endothelial_Cell_Frac => 1E-8,  # from rabbit tuning 
        mdl.eye.retina.PLQ => PLQ_Retina, 
        mdl.eye.retina.sigma_V => 0.99,    # Bussing and Shah, 2020; #  https://pubmed.ncbi.nlm.nih.gov/32876799/
        mdl.eye.retina.V_V => 3.26E-4 * 0.28, 
        mdl.eye.retina.V_IntS => 3.26E-4 * 0.32, 
        ...
        mdl.eye.choroid.Endothelial_Cell_Frac => 1E-7,  # from rabbit tuning 
        mdl.eye.choroid.PLQ => PLQ_Choroid, 
        mdl.eye.choroid.sigma_V => 0.99,    # Bussing and Shah, 2020; #  https://pubmed.ncbi.nlm.nih.gov/32876799/
        mdl.eye.choroid.V_V => 1.39E-4 * 0.23, 
        mdl.eye.choroid.V_IntS => 1.39E-4 * 0.34, 
