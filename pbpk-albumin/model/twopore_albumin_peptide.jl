...
# peptide at this point does not bind to albumin yet 
...
function albumin_peptide_pbpk_mtk(; name)
    ...
    vars = [C_Plasma; C_Plasma_Exo; C_LN; C_LN_Exo; CV_vars; CV_Exo_vars; CIS_vars; CIS_Exo_vars; UB_vars; UB_Exo_vars; B_vars; B_Exo_vars; F_vars; C_Plasma_Albud; C_LN_Albud; CV_Albud_vars; CE_Albud_vars; CIS_Albud_vars]
