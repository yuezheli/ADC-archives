...
function PLASMA(; name, exg)
    ...
    eqs = [
        Dt(C_Plasma) ~ Float64(exg) * (
            ...
            + L_LymphNode * C_LN
        ) / V_Plasma + infusion * Float64(exg) - (VMAX/V_Plasma) / (C_Plasma + KM) * C_Plasma - k_deconj * C_Plasma
    ]
...
function PL_plasma(; name)
    ...
    eqs = [
      Dt(C_PL_Plasma) ~ (
         ...
         + DAR * k_deconj * C_Plasma                            # from ADC deconjugation
...
connections_edg = [
        ...
        # shared parameters 
        param_subs = Dict{Any, Any}()

        # PL_tissue.V_IntS for all other organs (connect to igg_exg.V_IntS)
        param_subs[Organs[:liver].PL_tissue.V_IntS] = Organs[:liver].igg_exg.V_IntS
        param_subs[Organs[:lung].PL_tissue.V_IntS] = Organs[:lung].igg_exg.V_IntS
        param_subs[Organs[:heart].PL_tissue.V_IntS] = Organs[:heart].igg_exg.V_IntS
        param_subs[Organs[:muscle].PL_tissue.V_IntS] = Organs[:muscle].igg_exg.V_IntS
        param_subs[Organs[:skin].PL_tissue.V_IntS] = Organs[:skin].igg_exg.V_IntS
        param_subs[Organs[:adipose].PL_tissue.V_IntS] = Organs[:adipose].igg_exg.V_IntS
        param_subs[Organs[:bone].PL_tissue.V_IntS] = Organs[:bone].igg_exg.V_IntS
        param_subs[Organs[:brain].PL_tissue.V_IntS] = Organs[:brain].igg_exg.V_IntS
        param_subs[Organs[:kidney].PL_tissue.V_IntS] = Organs[:kidney].igg_exg.V_IntS
        param_subs[Organs[:sm_int].PL_tissue.V_IntS] = Organs[:sm_int].igg_exg.V_IntS
        param_subs[Organs[:la_int].PL_tissue.V_IntS] = Organs[:la_int].igg_exg.V_IntS
        param_subs[Organs[:pancreas].PL_tissue.V_IntS] = Organs[:pancreas].igg_exg.V_IntS
        param_subs[Organs[:thymus].PL_tissue.V_IntS] = Organs[:thymus].igg_exg.V_IntS
        param_subs[Organs[:spleen].PL_tissue.V_IntS] = Organs[:spleen].igg_exg.V_IntS
        param_subs[Organs[:other].PL_tissue.V_IntS] = Organs[:other].igg_exg.V_IntS
        param_subs[Organs[:marrow].PL_tissue.V_IntS] = Organs[:marrow].igg_exg.V_IntS
        # Eye components
        param_subs[Organs[:eye].icb.PL_tissue.V_IntS] = Organs[:eye].icb.igg_exg.V_IntS
        param_subs[Organs[:eye].retina.PL_tissue.V_IntS] = Organs[:eye].retina.igg_exg.V_IntS
        param_subs[Organs[:eye].choroid.PL_tissue.V_IntS] = Organs[:eye].choroid.igg_exg.V_IntS

        ## lymph flow
        param_subs[Organs[:plasma_exg].LF_LI] = Organs[:la_int].LF
        param_subs[Organs[:plasma_edg].LF_LI] = Organs[:la_int].LF
        param_subs[Organs[:plasma_exg].LF_Heart] = Organs[:heart].LF
        param_subs[Organs[:plasma_edg].LF_Heart] = Organs[:heart].LF
        param_subs[Organs[:plasma_exg].LF_Kidney] = Organs[:kidney].LF
        param_subs[Organs[:plasma_edg].LF_Kidney] = Organs[:kidney].LF
        param_subs[Organs[:plasma_exg].LF_Muscle] = Organs[:muscle].LF
        param_subs[Organs[:plasma_edg].LF_Muscle] = Organs[:muscle].LF
        param_subs[Organs[:plasma_exg].LF_Skin] = Organs[:skin].LF
        param_subs[Organs[:plasma_edg].LF_Skin] = Organs[:skin].LF
        param_subs[Organs[:plasma_exg].LF_Brain] = Organs[:brain].LF
        param_subs[Organs[:plasma_edg].LF_Brain] = Organs[:brain].LF
        param_subs[Organs[:plasma_exg].LF_Adipose] = Organs[:adipose].LF
        param_subs[Organs[:plasma_edg].LF_Adipose] = Organs[:adipose].LF
        param_subs[Organs[:plasma_exg].LF_Thymus] = Organs[:thymus].LF
        param_subs[Organs[:plasma_edg].LF_Thymus] = Organs[:thymus].LF
        param_subs[Organs[:plasma_exg].LF_Liver] = Organs[:liver].LF
        param_subs[Organs[:plasma_edg].LF_Liver] = Organs[:liver].LF
        param_subs[Organs[:plasma_exg].LF_Spleen] = Organs[:spleen].LF
        param_subs[Organs[:plasma_edg].LF_Spleen] = Organs[:spleen].LF
        param_subs[Organs[:plasma_exg].LF_Pancreas] = Organs[:pancreas].LF
        param_subs[Organs[:plasma_edg].LF_Pancreas] = Organs[:pancreas].LF
        param_subs[Organs[:plasma_exg].LF_SI] = Organs[:sm_int].LF
        param_subs[Organs[:plasma_edg].LF_SI] = Organs[:sm_int].LF
        param_subs[Organs[:plasma_exg].LF_Bone] = Organs[:bone].LF
        param_subs[Organs[:plasma_edg].LF_Bone] = Organs[:bone].LF
        param_subs[Organs[:plasma_exg].LF_Other] = Organs[:other].LF
        param_subs[Organs[:plasma_edg].LF_Other] = Organs[:other].LF
        param_subs[Organs[:plasma_exg].LF_Lung] = Organs[:lung].LF
        param_subs[Organs[:plasma_edg].LF_Lung] = Organs[:lung].LF
        param_subs[Organs[:plasma_exg].LF_Marrow] = Organs[:marrow].LF
        param_subs[Organs[:plasma_edg].LF_Marrow] = Organs[:marrow].LF
        # Note: eye LF values are set via p_dict string matching in helper-parameters.jl
        
        ## PLQ
        param_subs[Organs[:plasma_exg].PLQ_Heart] = Organs[:heart].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Heart] = Organs[:heart].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Kidney] = Organs[:kidney].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Kidney] = Organs[:kidney].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Muscle] = Organs[:muscle].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Muscle] = Organs[:muscle].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Skin] = Organs[:skin].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Skin] = Organs[:skin].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Brain] = Organs[:brain].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Brain] = Organs[:brain].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Adipose] = Organs[:adipose].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Adipose] = Organs[:adipose].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Thymus] = Organs[:thymus].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Thymus] = Organs[:thymus].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Liver] = Organs[:liver].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Liver] = Organs[:liver].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Spleen] = Organs[:spleen].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Spleen] = Organs[:spleen].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Pancreas] = Organs[:pancreas].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Pancreas] = Organs[:pancreas].PLQ
        param_subs[Organs[:plasma_exg].PLQ_SI] = Organs[:sm_int].PLQ
        param_subs[Organs[:plasma_edg].PLQ_SI] = Organs[:sm_int].PLQ
        param_subs[Organs[:plasma_exg].PLQ_LI] = Organs[:la_int].PLQ
        param_subs[Organs[:plasma_edg].PLQ_LI] = Organs[:la_int].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Bone] = Organs[:bone].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Bone] = Organs[:bone].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Other] = Organs[:other].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Other] = Organs[:other].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Lung] = Organs[:lung].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Lung] = Organs[:lung].PLQ
        param_subs[Organs[:plasma_exg].PLQ_Marrow] = Organs[:marrow].PLQ
        param_subs[Organs[:plasma_edg].PLQ_Marrow] = Organs[:marrow].PLQ
        # Note: eye PLQ values are set via p_dict string matching in helper-parameters.jl


        ## sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Heart] = Organs[:heart].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Heart] = Organs[:heart].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Kidney] = Organs[:kidney].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Kidney] = Organs[:kidney].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Muscle] = Organs[:muscle].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Muscle] = Organs[:muscle].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Skin] = Organs[:skin].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Skin] = Organs[:skin].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Brain] = Organs[:brain].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Brain] = Organs[:brain].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Adipose] = Organs[:adipose].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Adipose] = Organs[:adipose].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Thymus] = Organs[:thymus].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Thymus] = Organs[:thymus].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Liver] = Organs[:liver].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Liver] = Organs[:liver].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Spleen] = Organs[:spleen].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Spleen] = Organs[:spleen].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Pancreas] = Organs[:pancreas].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Pancreas] = Organs[:pancreas].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_SI] = Organs[:sm_int].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_SI] = Organs[:sm_int].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_LI] = Organs[:la_int].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_LI] = Organs[:la_int].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Bone] = Organs[:bone].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Bone] = Organs[:bone].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Other] = Organs[:other].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Other] = Organs[:other].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Lung] = Organs[:lung].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Lung] = Organs[:lung].sigma_IS
        param_subs[Organs[:ln_edg].sigma_IS_Marrow] = Organs[:marrow].sigma_IS
        param_subs[Organs[:ln_exg].sigma_IS_Marrow] = Organs[:marrow].sigma_IS
        # Note: eye sigma_IS values are set via p_dict string matching in helper-parameters.jl
        # No substitutions needed here since "icb", "retina", "choroid" match ln_*_sigma_IS_ICB etc.
        
        ## endothelial fraction
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Lung] = Organs[:lung].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Liver] = Organs[:liver].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Heart] = Organs[:heart].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Muscle] = Organs[:muscle].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Skin] = Organs[:skin].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Adipose] = Organs[:adipose].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Bone] = Organs[:bone].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Brain] = Organs[:brain].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Kidney] = Organs[:kidney].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_SI] = Organs[:sm_int].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_LI] = Organs[:la_int].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Pancreas] = Organs[:pancreas].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Thymus] = Organs[:thymus].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Spleen] = Organs[:spleen].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Other] = Organs[:other].Endothelial_Cell_Frac
        param_subs[Organs[:plasma_pl].Endothelial_Cell_Frac_Marrow] = Organs[:marrow].Endothelial_Cell_Frac
        # Note: eye Endothelial_Cell_Frac values are set via p_dict string matching


    pbpk_sys = ModelingToolkit.compose(System(connections, t, name=:pbpk), collect(values(Organs)); name=:pbpk)
    pbpk_sys_connected = substitute(pbpk_sys, param_subs)

    return pbpk_sys_connected
end
