...
function InfusionCallback(Dose_in_mgkg, mdl; 
    BW = human_WT, infusion_d = [0, 21], infusion_hr = 1, V_Plasma = 3.126, MW_EDG = MW_IGG, hr_per_day = hr_per_day)
    total_dose_uM = Dose_in_mgkg*BW*1E-3/V_Plasma/MW_EDG*1e6; # [uM]
    infusion_rates = total_dose_uM / infusion_hr
